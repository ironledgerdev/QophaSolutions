...
export const experienceGroups: ClientGroup[] = [
  ...
  },
  {
    ...
    clients: [
      { name: 'NTHA', category: 'Strategic Partners & NGO', imageSrc: '/logos/experience/ntha-board.png' },
      { name: 'Eastern Cape Liquor Board', category: 'Strategic Partners & NGO', imageSrc: '/logos/experience/eclb-board.png' },
      {
        name: 'Gauteng Liquor Forum',
        category: 'Strategic Partners & NGO',
        imageSrc: '/logos/experience/gauteng-liquor-forum-board.png',
      },
      { name: 'SABCOHA', category: 'Strategic Partners & NGO', imageSrc: '/logos/experience/sabcoha-board.png' },
      { name: 'South African Football Association', category: 'Strategic Partners & NGO', imageSrc: '/logos/experience/safa-board.png' },
    ],
  },
];
